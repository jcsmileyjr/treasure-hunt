...
export class AppComponent {
  ...
  gameOver = false;
  win= false;
  answers = ["eyeball","butterfly","doghouse" ,"cupcake","honeybee","starfish", "catfish", "sunflower", "rainbow", "watermelon", "football"];
  userAnswer = " ";
  correctAnswers = 0;
  imageList =[
    ...
    ["../assets/honey.png","../assets/bee.png"],
    ['../assets/star-pic.png',"https://api.creativecommons.engineering/v1/thumbs/ed2305f0-9a9f-47e1-8607-e2848e676136"],
    ...
    ["https://cdn.pixabay.com/photo/2016/03/08/21/50/watercolor-1244885_960_720.jpg","https://api.creativecommons.engineering/v1/thumbs/068c0384-c985-41c5-8e56-a8e03e8b2469"],
    ["../assets/corn.png","../assets/dog.png"],
    ['../assets/foot-pic.png',"https://api.creativecommons.engineering/v1/thumbs/d3a26ed2-1b0b-4ad3-90bc-8eb3e1a581e1"]
  ];
  canvas;
  interval;
  pauseTimer= false;
